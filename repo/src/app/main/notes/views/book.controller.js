(function ()
{
    ...
    /** @ngInject */
    function BookController($scope, $rootScope, $document, $mdDialog, $mdMedia, $mdSidenav, $state, msApi, Folders, Labels)
    {
        var vm = this;
        ...
        vm.views = {
            classic: 'app/main/books/views/classic/classic-view.html',
            outlook: 'app/main/books/views/outlook/outlook-view.html'
        };
        ...
        function init()
        {
            ...
            var apiName = 'mail.' + ($state.params.type || 'folder') + '.inbox@get';
        ...
        function composeDialog(ev)
        {
            $mdDialog.show({
                ...
                templateUrl        : 'app/main/books/dialogs/compose/compose-dialog.html',
