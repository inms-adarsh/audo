(function ()
{
    ...
    angular
        .module('app.notes')
        .controller('LogisticController', LogisticController);

    /** @ngInject */
    function LogisticController($scope, $rootScope, $document, $mdDialog, $mdMedia, $mdSidenav, $state, msApi, Folders, Labels)
    {
        var vm = this;
        ...
        vm.views = {
            classic: 'app/main/notes/views/classic/classic-view.html',
            outlook: 'app/main/notes/views/outlook/outlook-view.html'
        };
